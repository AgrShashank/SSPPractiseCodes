...
public class QuoteResultPage extends LoadableComponent<HomePage> {
	 ...
	 *            : Webdriver
	 */
	public QuoteResultPage(WebDriver driver, ExtentTest report) {
		this.driver = driver;
	...
	protected void isLoaded() {
		...
		if (!driver.getTitle().contains("SSP - Pure Insurance")) {
			Log.fail("Quote Result Page did not open up. Site might be down.", driver, extentedReport);
		} else {
			Log.message("Successfully navigated to Quote Result Page", driver, extentedReport, true);
		}
	}
