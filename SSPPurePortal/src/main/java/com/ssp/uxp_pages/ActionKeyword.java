...
public class ActionKeyword {
	...
	public static void performActionBasedOnFieldType(WebDriver driver, String pathType, String locatorType, String path,
		...
		case "assertPrimarySettledColumnInSearchTransactionTable":
			assertPrimarySettledValueInSearchTransactionTable(pathType, path, validMessage, errorMessage, driver,
					extentedReport, screenshot);
			break;
		case "verifySortedInDescendingOrder":
			verifySortedInDescendingOrder(fieldLabel, pathType, path, validMessage, errorMessage, driver,
					extentedReport, screenshot);
			break;
	...
	public static void enterTextUsingActionsClass(String fieldLabel, String pathType, String path, String input,
		...
		try {
			...
			actions.click(element).sendKeys(Keys.END).keyDown(Keys.SHIFT).sendKeys(Keys.HOME).keyUp(Keys.SHIFT).sendKeys(Keys.BACK_SPACE).sendKeys(input).perform();
	...
	/**
	 * To check element is displayed in page if it is present then should click
	 * it
	 * 
	 * @param fieldLabel
	 * @param pathType
	...
	/**
	 * To verify Policy/Quotes Count displays same in overview and policy/Quotes
	 * tab
	 * 
	 * @param fieldLabel
	 * @param pathType
	...
	/**
	 * assert to find values are sorted and listed or not in insurer premium
	 * column
	 * 
	 * @param fieldLabel
	 * @param pathType
	...
	/**
	 * This method stores the run time values in a Hashmap<String, String> where
	 * Key and value is String. Here Key is a fieldlabel name and value is
	 * stored at run time.
	 * 
	 * @param fieldLabel
	 * @param pathType
	...
	/**
	 * Validate the outstanding amount with the amount in the Search
	 * Transactions. Here field label should be added in the dynamic hash map
	 * which we used as an amount to validate. And capture outstanding amount at
	 * run time.
	 * 
	 * @param fieldLabel
	 * @param pathType
	...
	/**
	 * This method validates the Journal transactions reference number starts
	 * with "JN".
	 * 
	 * @param fieldLabel
	 * @param pathType
	...
	public static void verifySearchTransactionsTableHeaderWithRows(String input, String fieldLabel, String pathType,
		...
		try {
			...
			if (!tableData.get("Branch").equalsIgnoreCase("HeadOff"))
				status = false;
			if (!tableData.get("Account").equalsIgnoreCase(dynamicHashMap.get("Company Code")))
				status = false;
			...
			if (!tableData.get("Effective Date").equalsIgnoreCase(todayDate))
				status = false;
			if (!tableData.get("O/S Amount").equalsIgnoreCase(dynamicHashMap.get("Premium")))
				status = false;
	...
	/**
	 * This method adds the data in a dynamic Hash Map as per label and its
	 * input of View Transactions in Accounts tab.
	 * 
	 * @param input
	 *            adds as a prefix in a key
	 * @param fieldLabel
	 * @param pathType
	 *            should always be XPath
	 * @param path
	 * @param validMessage
	 * @param errorMessage
	 * @param driver
	...
	/**
	 * Validate the input fields for tab client in view transaction screen for
	 * SND transactions
	 * 
	 * @param validMessage
	 * @param errorMessage
	...
	/**
	 * /** Validate the input fields for tab amounts in view transaction screen
	 * for SRP transactions
	 * 
	 * @param validMessage
	 * @param errorMessage
	 * @param driver
	...
	/**
	 * Validate the input fields of the tab Income history in view transaction
	 * for SND reference.
	 * 
	 * @param validMessage
	 * @param errorMessage
	...
	/**
	 * Validate the input fields of tab Details which are in View Transaction
	 * for the SND transactions
	 * 
	 * @param validMessage
	 * @param errorMessage
	 * @param driver
	...
	/**
	 * Validate the data of the View Transaction main input fields which are
	 ...
	 * @throws Exception
	 */
	public static void isVisible(String fieldLabel, String pathType, String path, String type,
	...
	public static void verifySortedInDescendingOrder(String fieldLabel, String pathType, String path, 
		...
		try {
			...
			boolean status=false;
				...
				Log.softAssertThat(status, validMessage,
				"Fail to achieve expected result : " + errorMessage, driver, extentedReport, screenshot);
