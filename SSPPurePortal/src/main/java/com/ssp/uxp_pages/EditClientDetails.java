...
public class EditClientDetails extends LoadableComponent<HomePage> {
	 ...
	 *            : Webdriver
	 */
	public EditClientDetails(WebDriver driver, ExtentTest report) {
		this.driver = driver;
	...
	protected void isLoaded() {
		...
		if (!driver.getTitle().contains("Corporate Client Details")) {
			Log.fail("Edit Client Details Page did not open up. Site might be down.", driver, extentedReport);
		} else {
			Log.message("Successfully navigated to Edit Client Details Page", driver, extentedReport);
		}
	}
