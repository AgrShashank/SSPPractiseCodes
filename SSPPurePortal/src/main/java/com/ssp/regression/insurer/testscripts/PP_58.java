...
public class PP_58 extends BaseTest {

	private String webSite, mode;
	public String PCLwebSite;
	String featureId = "PP_58_";
	...
	@Test(description = "Verify that 'Insurer' column is visible with no values  in summary of cover screen when it has empty lead insurer for broker mode", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC58_8205(String browser) throws Exception {
	...
	@Test(description = "Verify that 'Insurer' column has related Insurer name in summary of cover screen for a created policy/Quote  for broker mode", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC58_8207(String browser) throws Exception {
	...
	@Test(description = "Verify that 'Insurer' column has related Insurer name in summary of cover screen after we buy the policy", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC58_8206(String browser) throws Exception {
