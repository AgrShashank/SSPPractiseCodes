...
public class PP_5766_Viewing_Collections_Central_Transaction_Data extends BaseTest {

	private String webSite, mode;
	public String PCLwebSite;
	String featureId = "PP_5766_Viewing_Collections_Central_Transaction_Data_";
	...
	@Test(description = "Validate the data of SRP transactions", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_5766_01(String browser) throws Exception {
