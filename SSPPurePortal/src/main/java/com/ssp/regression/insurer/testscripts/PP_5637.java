...
public class PP_5637 extends BaseTest {

	private String webSite, mode;
	public String PCLwebSite;
	String featureId = "PP_5637_";
	...
	@Test(description = "Raise an invoice during Quote and Buy process", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC1395_01(String browser) throws Exception {
