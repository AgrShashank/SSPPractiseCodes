...
public class PP_5679_Enter_Transaction_Comment extends BaseTest {

	private String webSite, mode;
	public String PCLwebSite;
	String featureId = "PP_5679_Enter_Transaction_Comment_";
	...
	@Test(description = "Enter Transaction comment for SND Transactions", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_5679_01(String browser) throws Exception {
	...
	@Test(description = "Enter Transaction comment for SRP Transactions", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_5679_02(String browser) throws Exception {
