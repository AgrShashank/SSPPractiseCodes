...
public class PP_5524 extends BaseTest {

	private String webSite, mode;
	public String PCLwebSite;
	String featureId = "PP_5524_";
	...
	@Test(description = " Collection with Full Allocation to Single Invoice ", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC1432_01(String browser) throws Exception {
