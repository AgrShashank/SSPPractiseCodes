...
public class PP_6675_5676 extends BaseTest {

	private String webSite, mode;
	public String PCLwebSite;
	String featureId = "PP_6675_5676_";
	...
	@Test(description = "Build Central Transaction View UI with Pay Now policy", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_5676_01(String browser) throws Exception {
		...
		try {
			 ...
			 * browser + "]</b></i></small>"); extentedReport =
	...
	@Test(description = "Build Central Transaction View UI with Pay Now policy", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_5676_02(String browser) throws Exception {
		String tcId = new Object() {
		}.getClass().getEnclosingMethod().getName();
		final WebDriver driver = WebDriverFactory.get(browser);
