...
public class PP_39 extends BaseTest {

	private String webSite, mode;
	public String PCLwebSite;
	String featureId = "PP_39_";
	...
	@Test(description = "Verify whether the values in policy header are populated from the fields 'Quote recommendation' and 'Client requirement' of quote in quote result", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC39_8202(String browser) throws Exception {
	...
	@Test(description = "Verify whether the values in policy header are populated from the fields 'Quote recommendation' and 'Client requirement' referred quote from quote result", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC39_8211(String browser) throws Exception {
