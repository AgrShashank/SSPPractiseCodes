...
public class EndToEnd_NB_Process extends BaseTest {

	private String webSite, mode;
	public String PCLwebSite;
	String featureId = "EndToEnd_NB_Process_";
	...
	@Test(description = "Verify whether user can buy policy for the cover type 'Guest House' using Pay now method", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC8453(String browser) throws Exception {
	...
	@Test(description = "Verify whether user can buy policy for the cover type 'Guest House'", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC8455(String browser) throws Exception {
	...
	@Test(description = "Verify whether user can buy policy for the cover type 'Holiday Homes'", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC8456(String browser) throws Exception {
	...
	@Test(description = "Verify whether user can buy policy for the cover type 'Staff Accommodation'", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC8457(String browser) throws Exception {
