...
public class HIUAUpdated2 {
                ...
                public static void main(String[] args) throws InterruptedException, AWTException {
                                ...
                                driver.get("https:\\www.sit.broking-test.ssp-development.com/Pure.Portal/LoginPlatform.aspx");

                                driver.manage().window().maximize();
                                driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);

                                driver.findElement(By.id("username")).sendKeys("situser1@sit.com");
                                ...
                                //driver.findElement(By.cssSelector("#btn btn-ssp-secondary")).click();
                                //driver.findElement(By.name("btn btn-ssp-secondary")).click();
                                driver.findElement(By.id("ctl00_cntMainBody_txtClientCode")).sendKeys("newe");
                               ...
                               Thread.sleep(5000);
                                ...
                                driver.findElement(By.cssSelector("#C1__Screen_SSd_GENDETS_0_T__DATA_SET_rISK_OBJECTS_Component_HIUAGH_POLICY_BINDER_Component_GENERAL_DETAILS_TRADING_NAME"))
                                                                .sendKeys("Sandeep");
                              //  #C1__Screen_SSd_GENDETS_0_T__DATA_SET_rISK_OBJECTS_Component_HIUAGH_POLICY_BINDER_Component_GENERAL_DETAILS_TELEPHONE_NUM
                               ...
                               /* JavascriptExecutor js = (JavascriptExecutor) driver;  
                                ...
                                Thread.sleep(4000);
                                driver.findElement(By.cssSelector("#C1__Back-Screen_SSd_GENDETS_1_T")).click();
                                Thread.sleep(4000);
                                ...
                                js.executeScript("document.getElementById('C1__C1__QUE_BA23D49FD83824B31924').value='B37 7YE';");
                                //driver.findElement(By.cssSelector("#C1__C1__QUE_BA23D49FD83824B31924")).sendKeys("B37 7YE");
                                System.out.println("Entered postcode again risk1 screen");
                                Thread.sleep(2000);
...
//                                Thread.sleep(2000);
                                ...
                                System.out.println("Entered postcode again risk 2 screen");
                                Thread.sleep(5000);
                                driver.findElement(By.cssSelector("#C1__C1__QUE_4ABA2D83CE3F6B8189114")).click();
                                System.out.println(driver.findElement(By.cssSelector("#C1__C1__QUE_4ABA2D83CE3F6B8189114")).getText());
                                Thread.sleep(3000);
