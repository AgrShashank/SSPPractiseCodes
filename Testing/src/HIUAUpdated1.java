...
public class HIUAUpdated1 {
                ...
                public static void main(String[] args) throws InterruptedException, AWTException {
                                ...
                                driver.get("https://ssppureportal-devt.ssp-development.com/Pure.PortalDev2/secure/agent/findclient.aspx");
                                ...
                                driver.findElement(By.id("ctl00_cntMainBody_txtClientCode")).sendKeys("CORPC");
                               ...
                               TParty.click(); Select TP = new Select(TParty); TP.selectByIndex(3);
                           */    
                                action.sendKeys(Keys.PAGE_UP).build().perform();
                                Thread.sleep(1000);
